...
export class ClientRequestApi {
  ...
  public findByIndividualPaged(organisationId: string | any, pageNumber: number | any, pageSize: number | any): Observable<Page<ClientRequestDTO> | any> {

    return this.http.get<Page<ClientRequestDTO> | any>(`${this.path}/by-individual/${organisationId}/paged?pageNumber=${pageNumber}&pageSize=${pageSize}`);
  }
