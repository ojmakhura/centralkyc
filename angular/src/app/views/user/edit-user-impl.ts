...
import { EditUserComponent } from '@views/user/edit-user';
import { EditUserVarsForm } from '@views/user/edit-user';
...
import { ChangePasswordImplComponent } from '@views/user/change-password-impl';
